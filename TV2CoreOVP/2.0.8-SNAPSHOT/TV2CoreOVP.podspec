    ...
    s.source          = { :http => "http://repository.neonstingray.com/service/local/repositories/thirdparty/content/tv2/core/ovp/ios/core-ovp/2.0.8-SNAPSHOT/TV2CoreOVP-2.0.8-SNAPSHOT.zip" }
    s.platform        = :ios, '7.0'
    s.source_files    = '*.h'
