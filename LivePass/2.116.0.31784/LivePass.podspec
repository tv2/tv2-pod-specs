Pod::Spec.new do |s|
  s.name            = "LivePass"
  s.version         = "2.116.0.31784"
  s.homepage        = "https://developer.conviva.com"
  s.source          = { :http => "https://github.com/tv2/apps-apple-external-repositories/raw/master/LivePass/2.116.0.31784/livepass-2.116.0.31784.zip" }
  s.platform        = :ios
