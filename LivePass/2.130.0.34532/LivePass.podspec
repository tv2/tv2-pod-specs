Pod::Spec.new do |s|
  s.name            = "LivePass"
  s.version         = "2.130.0.34532"
  s.homepage        = "https://developer.conviva.com"
  s.source          = { :http => "https://github.com/tv2/apps-apple-external-repositories/raw/master/LivePass/2.130.0.34532/livepass-2.130.0.34532.zip" }
  s.platform        = :ios
