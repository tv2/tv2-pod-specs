    ...
    s.source          = { :http => "http://repository.neonstingray.com/service/local/repositories/thirdparty/content/tv2/core/ovp/tvos/core-ovp/2.0.4/TV2CoreOVPTVOS-2.0.4.zip" }
    s.platform        = :tvos, '9.0'
    s.source_files    = '*.h'
