    ...
    s.version         = "2.0.8-SNAPSHOT"
    s.homepage        = "http://tv2.dk/"
    s.source          = { :http => "http://repository.neonstingray.com/service/local/repositories/thirdparty/content/tv2/core/ovp/tvos/core-ovp/2.0.8-SNAPSHOT/TV2CoreOVPTVOS-2.0.8-SNAPSHOT.zip" }
    s.platform        = :tvos, '9.0'
    s.source_files    = '*.h'
