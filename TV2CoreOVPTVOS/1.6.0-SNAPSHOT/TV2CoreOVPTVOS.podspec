    ...
    s.source          = { :http => "http://repository.neonstingray.com/service/local/repositories/thirdparty/content/tv2/core/ovp/tvos/core-ovp/1.6.0-SNAPSHOT/TV2CoreOVPTVOS-1.6.0-SNAPSHOT.zip" }
    s.platform        = :tvos, '7.0'
    s.source_files    = '*.h'
    s.preserve_paths  = 'libTV2CoreOVPTVOS.a'
    s.xcconfig        = { 'LIBRARY_SEARCH_PATHS' => '"/TV2CoreOVPTVOS"'}
    s.requires_arc    = true
