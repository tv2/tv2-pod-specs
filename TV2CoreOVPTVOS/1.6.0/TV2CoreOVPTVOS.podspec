    ...
    s.source          = { :http => "http://repository.neonstingray.com/service/local/repositories/thirdparty/content/tv2/core/ovp/tvos/core-ovp/1.6.0/TV2CoreOVPTVOS-1.6.0.zip" }
    s.platform        = :tvos, '7.0'
    s.source_files    = '*.h'
