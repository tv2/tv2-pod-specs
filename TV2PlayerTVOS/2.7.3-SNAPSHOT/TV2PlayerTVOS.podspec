    ...
    s.version         = "2.7.3-SNAPSHOT"
    s.homepage        = "http://tv2.dk/"
    s.source          = { :http => "http://repository.neonstingray.com/service/local/repositories/thirdparty/content/tv2/syndicatedplayer/tvos/syndicated-player/2.7.3-SNAPSHOT/TV2PlayerTVOS-2.7.3-SNAPSHOT.zip" }
    s.platform        = :tvos, '9.0'
    ...
    s.dependency 'TV2CoreOVPTVOS', '~> 2.0.5'
