    ...
    s.source          = { :http => "http://repository.neonstingray.com/service/local/repositories/thirdparty/content/tv2/syndicatedplayer/tvos/syndicated-player/2.7.2.1/TV2PlayerTVOS-2.7.2.1.zip" }
    s.platform        = :tvos, '9.0'
