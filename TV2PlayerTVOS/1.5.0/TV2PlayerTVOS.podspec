Pod::Spec.new do |s|
  ...
  s.source          = { :http => "http://repository.neonstingray.com/content/repositories/thirdparty/tv2/syndicatedplayer/tvos/syndicated-player/1.5.0/syndicated-player-1.5.0.zip" }
  s.platform        = :tvos, '9.0'
