    ...
    s.source          = { :http => "http://repository.neonstingray.com/service/local/repositories/thirdparty/content/tv2/syndicatedplayer/tvos/syndicated-player/2.7.2.2/TV2PlayerTVOS-2.7.2.2.zip" }
    s.platform        = :tvos, '9.0'
