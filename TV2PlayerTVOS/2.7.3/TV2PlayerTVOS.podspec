    ...
    s.source          = { :http => "http://repository.neonstingray.com/service/local/repositories/thirdparty/content/tv2/syndicatedplayer/tvos/syndicated-player/2.7.3/TV2PlayerTVOS-2.7.3.zip" }
    s.platform        = :tvos, '9.0'
    ...
    s.dependency 'TV2CoreOVPTVOS', '~> 2.0.9'
