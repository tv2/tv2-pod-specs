Pod::Spec.new do |s|
    ...
    s.source   = { :http => "http://repository.neonstingray.com/content/repositories/thirdparty/com/afnetworkactivitylogger/ios/afnetworkactivitylogger/3.0.0/afnetworkactivitylogger-3.0.0.zip" }
