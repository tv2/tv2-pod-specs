Pod::Spec.new do |s|
  ...
  s.source          = { :http => "http://repository.neonstingray.com/content/repositories/thirdparty/com/microsoft/playready/ios/playready-player/2.3.2000tv2/playready-player-2.3.2000tv2.zip" }
  s.platform        = :ios
