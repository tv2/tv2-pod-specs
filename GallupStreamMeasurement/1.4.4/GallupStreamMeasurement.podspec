Pod::Spec.new do |s|
  ...
  s.source          = { :http => "http://repository.neonstingray.com/content/repositories/thirdparty/de/spring/mobile/app-streaming-ios/1.4.4/spring-appstreaming-iOS-tns-dk-1.4.4.zip" }
  s.platform        = :ios
