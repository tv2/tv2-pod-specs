Pod::Spec.new do |s|
  ...
  s.source          = { :http => "http://repository.neonstingray.com/content/repositories/thirdparty/tv2/syndicatedplayer/ios/syndicated-player/2.5.2/syndicated-player-2.5.2.zip" }
  s.platform        = :ios, '7.0'
