Pod::Spec.new do |s|
  ...
  s.source          = { :http => "http://repository.neonstingray.com/content/repositories/thirdparty/tv2/syndicatedplayer/ios/syndicated-player/2.4.0/syndicated-player-2.4.0.zip" }
  s.platform        = :ios, '7.0'
  ...
  s.dependency 'TV2CoreOVP', '1.4.0.001'
end
