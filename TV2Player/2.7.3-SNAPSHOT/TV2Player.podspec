    ...
    s.source          = { :http => "http://repository.neonstingray.com/service/local/repositories/thirdparty/content/tv2/syndicatedplayer/ios/syndicated-player/2.7.3-SNAPSHOT/TV2Player-2.7.3-SNAPSHOT.zip" }
    s.platform        = :ios, '7.0'
