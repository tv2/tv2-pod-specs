Pod::Spec.new do |s|
  ...
  s.source          = { :http => "http://repository.neonstingray.com/content/repositories/thirdparty/tv2/syndicatedplayer/ios/syndicated-player/2.5.1/syndicated-player-2.5.1.zip" }
  s.platform        = :ios, '7.0'
